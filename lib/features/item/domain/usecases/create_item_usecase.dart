...
class CreateItemUsecaseParams extends Equatable {
...
class CreateItemUsecase
    implements UsecaseWithParams<ItemEntity, CreateItemUsecaseParams> {
  ...
  Future<Either<Failure, ItemEntity>> call(
    CreateItemUsecaseParams params,
  ) async {
    ...
    return await _itemRepository.createItem(itemEntity);
  }
}
