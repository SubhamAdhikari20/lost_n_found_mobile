...
class CategoryViewModel extends Notifier<CategoryState> {
  ...
  Future<void> createCategory({
    ...
    result.fold(
      ...
      (success) {
        state = state.copyWith(categoryStatus: CategoryStatus.created);
        getAllCategories();
      },
    );
  }
  ...
  Future<void> updateCategory({
    ...
    result.fold(
      ...
      (success) {
        state = state.copyWith(categoryStatus: CategoryStatus.updated);
        getAllCategories();
      },
    );
  }
  ...
  Future<void> deleteCategory(String categoryId) async {
    ...
    result.fold(
      ...
      (success) {
        state = state.copyWith(categoryStatus: CategoryStatus.deleted);
        getAllCategories();
      },
    );
  }
