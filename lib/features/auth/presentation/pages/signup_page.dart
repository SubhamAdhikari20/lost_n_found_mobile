  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<AuthState>(authViewModelProvider, (previous, next) {
      if (next.authStatus == AuthStatus.error && next.errorMessage != null) {
        SnackbarUtils.showError(context, next.errorMessage ?? "Sign Up Failed");
      } else if (next.authStatus == AuthStatus.authenticated) {
        // Sign Up Successful
        SnackbarUtils.showSuccess(context, "Sign Up Successful");
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: batchState.batchStatus == BatchStatus.loading
                          ? 'Loading batches...'
                          : 'Choose your batch',
                  ...
                  GradientButton(
                    ...
                    isLoading: authState.authStatus == AuthStatus.loading,
                  ),
                  const SizedBox(height: 32),
